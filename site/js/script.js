...
$('.servicioslider, .staffslider').slick({
  prevArrow: '<button class="slick-prev fa fa-caret-left"></button>',
  nextArrow: '<button class="slick-next fa fa-caret-right"></button>',
  autoplay: false,
  arrows: false,
...
$('.dr1').removeClass('nonactivedr').addClass('activedr');
...
function gotoSlider(wich,numb, _th){
  $(wich).slick('slickGoTo', numb);
  $('.activedr').removeClass('activedr').addClass('nonactivedr');
  $(_th).removeClass('nonactivedr').addClass('activedr');
}
